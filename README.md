...
A plain-English handbook for the people who will actually use it — no technical knowledge assumed — ships with the app: [**PDF**](docs/Photo-Archive-Handbook.pdf) to send or print, [HTML](docs/handbook.html) to read in a browser.
